      ...
      <div className="mt-6 space-y-5 px-4">
        ...
        <div className="relative overflow-hidden rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-gray-100">
          ...
          <div className="relative z-10 flex flex-col gap-5">
            ...
            {profile.ultrasoundLastMenstrualPeriod && (
              <div className="flex items-start gap-4">
                <div className="rounded-2xl bg-violet-50 p-3 text-violet-600">
                  <ClockCheck size={22} />
                </div>
                <div>
                  <p className="mb-1 text-xs font-medium uppercase tracking-wider text-gray-500">Ultrasound-Equivalent LMP</p>
                  <p className="font-semibold text-gray-900">{formatDate(profile.ultrasoundLastMenstrualPeriod)}</p>
                </div>
              </div>
            )}
            <div className="flex items-start gap-4">
